...
<!--        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>-->
      ...
      <div class="flex items-center md:order-2">
        ...
        <button class="mr-5 inline-flex text-blue-300" id="dropdownNotificationButton" @click="toggleNotification" data-dropdown-toggle="dropdownNotification" type="button">
        ...
        <button class="float-right" @click="toggleDropdown" id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar" type="button">
  ...
  <!-- Dropdown menu -->
  <div id="dropdownInformation" v-if="showDropdown" class="absolute z-[30] bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 border-2 border-blue-500 w-fit mx-6 lg:right-16 lg:top-20 md:right-6 md:top-32 top-32">
...
<!--    </ul>-->
  ...
  <!-- Dropdown menu -->
  <div id="dropdownNotification" v-if="showNotifications" class="absolute z-[20] w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700 border-2 border-blue-500 w-fit mx-6 lg:right-16 lg:top-20 md:right-6 md:top-32 top-32" aria-labelledby="dropdownNotificationButton">
